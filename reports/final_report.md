...
表4より、アンテナ1のチャネル振幅は約1.533、アンテナ2のチャネル振幅は約0.309であり、アンテナ1の受信電力がアンテナ2より大きいことが分かる。この差は表5の単一フレーム結果にも現れており、アンテナ1では0から2ビットの誤りであったのに対し、アンテナ2では14から18ビットの誤りが発生した。したがって、このデータではアンテナ1の方が信頼できる受信系列であったと考えられる。

同一アンテナの2タイムスロット合成では、アンテナ1で0誤り、アンテナ2で8誤りとなった。アンテナ2では単一フレームの14、18誤りから改善しているため、複数タイムスロットを合成することで雑音の影響を小さくできたと考えられる。

一方で、2アンテナ重み付き合成では1ビット誤りが残った。アンテナ2の重みは約0.039と小さいが、受信品質が低いため、合成後の判定に少し影響した可能性がある。このことから、ダイバーシチ合成では複数の受信系列を用いるだけでなく、各系列の信頼度に応じて重みを決めることが重要であると分かった。
